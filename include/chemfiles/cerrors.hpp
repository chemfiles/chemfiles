...
struct CAPIStatus {
    ...
    CAPIStatus() {
        ...
        messages_[MEMORY] = "Memory error. Use chfl_last_error for more "
                            "informations.";
        messages_[FILE] = "Error while reading a file. Use chfl_last_error for "
                          "more informations.";
        messages_[FORMAT] = "Error while reading a format. Use chfl_last_error "
                            "for more informations.";
        messages_[SELECTION] = "Error in selection string parsing. Use "
                               "chfl_last_error for more informations.";
        messages_[CHEMFILES] = "Error in chemfiles library. Use "
                               "chfl_last_error for more informations.";
        messages_[CXX_ERROR] = "Error in C++ runtime. Use chfl_last_error "
                               "for more informations.";
    }
