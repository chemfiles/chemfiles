...
# sphinx-quickstart on Thu Dec 11 01:24:30 2014.
#
...
# Breathe projects
breathe_projects = { "Harp": os.path.join(DOC_ROOT, "doxygen", "xml") }
...
texinfo_documents = [
  ('index', 'Harp', u'Harp Documentation',
   u'Guillaume Fraux', 'Harp', 'One line description of project.',
   'Miscellaneous'),
]
