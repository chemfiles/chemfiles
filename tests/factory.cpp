...
TEST_CASE("Geting registered format", "[Trajectory factory]"){
    TrajectoryFactory::register_extension(".dummy", {new_format<DummyFormat>, new_file<typename DummyFormat::file_t>});
    TrajectoryFactory::register_format("Dummy", {new_format<DummyFormat>, new_file<typename DummyFormat::file_t>});
...
TEST_CASE("Geting file type associated to a format", "[Trajectory factory]"){
    TrajectoryFactory::register_extension(".dummy2", {new_format<DummyFormat2>, new_file<typename DummyFormat2::file_t>});
    DummyFile dummy("", "");
