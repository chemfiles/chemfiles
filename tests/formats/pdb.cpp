...
TEST_CASE("Write files in PDB format", "[PDB]"){
    ...
    "HETATM    0    A RES X   0       1.000   2.000   3.000  0.00  0.00           A\n"
    "HETATM    1    B RES X   1       1.000   2.000   3.000  0.00  0.00           B\n"
    "HETATM    2    C RES X   2       1.000   2.000   3.000  0.00  0.00           C\n"
    "HETATM    3    D RES X   3       1.000   2.000   3.000  0.00  0.00           D\n"
    "CONECT    0    1\n"
    "CONECT    1    0\n"
    "END\n"
    "CRYST1   22.000   22.000   22.000  90.00  90.00  90.00 P 1           1\n"
    "HETATM    0    A RES X   0       4.000   5.000   6.000  0.00  0.00           A\n"
    "HETATM    1    B RES X   1       4.000   5.000   6.000  0.00  0.00           B\n"
    "HETATM    2    C RES X   2       4.000   5.000   6.000  0.00  0.00           C\n"
    "HETATM    3    D RES X   3       4.000   5.000   6.000  0.00  0.00           D\n"
    "HETATM    4    E RES X   4       4.000   5.000   6.000  0.00  0.00           E\n"
    "HETATM    5    F RES X   5       4.000   5.000   6.000  0.00  0.00           F\n"
    "CONECT    0    1\n"
    "CONECT    1    0\n"
    "CONECT    4    5\n"
    "CONECT    5    4\n"
