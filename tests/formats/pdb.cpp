...
TEST_CASE("Write files in PDB format", "[PDB]"){
    ...
    "HETATM    1    A RES X   1       1.000   2.000   3.000  0.00  0.00           A\n"
    "HETATM    2    B RES X   2       1.000   2.000   3.000  0.00  0.00           B\n"
    "HETATM    3    C RES X   3       1.000   2.000   3.000  0.00  0.00           C\n"
    "HETATM    4    D RES X   4       1.000   2.000   3.000  0.00  0.00           D\n"
    "CONECT    1    2\n"
    "CONECT    2    1\n"
    "END\n"
    "CRYST1   22.000   22.000   22.000  90.00  90.00  90.00 P 1           1\n"
