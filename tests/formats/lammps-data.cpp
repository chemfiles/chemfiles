...
TEST_CASE("Write files in LAMMPS data format with custom topo types") {
    const auto EXPECTED_CONTENT =
    "LAMMPS data file -- atom_style full -- generated by chemfiles\n"
    "6 atoms\n"
    "4 bonds\n"
    ...
    frame.add_atom(Atom("B"), {1.1, 2.2, 3.3}, {0.1, 0.2, 0.3});
    frame.add_atom(Atom("C"), {1.1, 2.2, 3.3}, {0.1, 0.2, 0.3});
    frame.add_bond(2, 1, Bond::UNKNOWN, "typeA");
    frame.add_bond(2, 3, Bond::UNKNOWN, "typeB");
    frame.add_bond(2, 4, Bond::UNKNOWN, "typeC");
    frame.add_bond(4, 5, Bond::UNKNOWN, "typeD");
