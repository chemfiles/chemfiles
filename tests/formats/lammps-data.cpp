...
TEST_CASE("Write files in LAMMPS data format with explicit types") {
    ...
    frame.add_atom(Atom("B"), {1.1, 2.2, 3.3}, {0.1, 0.2, 0.3});
    frame.add_atom(Atom("C"), {1.1, 2.2, 3.3}, {0.1, 0.2, 0.3});
    frame.add_bond(2, 1, "1");
    frame.add_bond(2, 3, "2");
    frame.add_bond(2, 4, "3");
    frame.add_bond(4, 5, "4");

    frame.add_angle(2, 3, 4, "1");
    frame.add_angle(2, 3, 5, "2");
    frame.add_angle(3, 5, 6, "3");
    frame.add_angle(4, 3, 5, "4");

    frame.add_dihedral(2, 3, 5, 6, "1");
    frame.add_dihedral(4, 3, 5, 6, "2");

    frame.add_improper(2, 3, 4, 5, "1");
